    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trade_no', models.CharField(blank=True, max_length=100, null=True, unique=True, verbose_name='交易单号')),
                ('pay_status', models.CharField(choices=[('SUCCESS', '成功'), ('CLOSED', '超时关闭'), ('WAIT_BUYER_PAY', '交易创建'), ('FINISHED', '交易结束'), ('PAYING', '待支付')], default='PAYING', max_length=30, verbose_name='订单状态')),
